class Particles {
  ...
  static const ParticleType angry_villager = ParticleType('minecraft:angry_villager');
  ...
  static const ParticleType block_marker = ParticleType('minecraft:block_marker');

  /// _(minecraft:bubble)_
  static const ParticleType bubble = ParticleType('minecraft:bubble');

  /// _(minecraft:bubble_column_up)_
  static const ParticleType bubble_column_up = ParticleType('minecraft:bubble_column_up');
  ...
  static const ParticleType campfire_cosy_smoke = ParticleType('minecraft:campfire_cosy_smoke');

  /// _(minecraft:campfire_signal_smoke)_
  static const ParticleType campfire_signal_smoke = ParticleType('minecraft:campfire_signal_smoke');

  /// _(minecraft:cherry_leaves)_
  static const ParticleType cherry_leaves = ParticleType('minecraft:cherry_leaves');
  ...
  static const ParticleType crimson_spore = ParticleType('minecraft:crimson_spore');

  /// _(minecraft:crit)_
  static const ParticleType crit = ParticleType('minecraft:crit');

  /// _(minecraft:current_down)_
  static const ParticleType current_down = ParticleType('minecraft:current_down');

  /// _(minecraft:damage_indicator)_
  static const ParticleType damage_indicator = ParticleType('minecraft:damage_indicator');

  /// _(minecraft:dolphin)_
  static const ParticleType dolphin = ParticleType('minecraft:dolphin');

  /// _(minecraft:dragon_breath)_
  static const ParticleType dragon_breath = ParticleType('minecraft:dragon_breath');

  /// _(minecraft:dripping_dripstone_lava)_
  static const ParticleType dripping_dripstone_lava = ParticleType('minecraft:dripping_dripstone_lava');

  /// _(minecraft:dripping_dripstone_water)_
  static const ParticleType dripping_dripstone_water = ParticleType('minecraft:dripping_dripstone_water');

  /// _(minecraft:dripping_honey)_
  static const ParticleType dripping_honey = ParticleType('minecraft:dripping_honey');

  /// _(minecraft:dripping_lava)_
  static const ParticleType dripping_lava = ParticleType('minecraft:dripping_lava');

  /// _(minecraft:dripping_obsidian_tear)_
  static const ParticleType dripping_obsidian_tear = ParticleType('minecraft:dripping_obsidian_tear');

  /// _(minecraft:dripping_water)_
  static const ParticleType dripping_water = ParticleType('minecraft:dripping_water');

  /// _(minecraft:dust)_
  static const ParticleType dust = ParticleType('minecraft:dust');

  /// _(minecraft:dust_color_transition)_
  static const ParticleType dust_color_transition = ParticleType('minecraft:dust_color_transition');

  /// _(minecraft:dust_pillar)_
  static const ParticleType dust_pillar = ParticleType('minecraft:dust_pillar');
  ...
  static const ParticleType elder_guardian = ParticleType('minecraft:elder_guardian');

  /// _(minecraft:electric_spark)_
  static const ParticleType electric_spark = ParticleType('minecraft:electric_spark');

  /// _(minecraft:enchant)_
  static const ParticleType enchant = ParticleType('minecraft:enchant');

  /// _(minecraft:enchanted_hit)_
  static const ParticleType enchanted_hit = ParticleType('minecraft:enchanted_hit');

  /// _(minecraft:end_rod)_
  static const ParticleType end_rod = ParticleType('minecraft:end_rod');

  /// _(minecraft:entity_effect)_
  static const ParticleType entity_effect = ParticleType('minecraft:entity_effect');
  ...
  static const ParticleType explosion_emitter = ParticleType('minecraft:explosion_emitter');

  /// _(minecraft:falling_dripstone_lava)_
  static const ParticleType falling_dripstone_lava = ParticleType('minecraft:falling_dripstone_lava');

  /// _(minecraft:falling_dripstone_water)_
  static const ParticleType falling_dripstone_water = ParticleType('minecraft:falling_dripstone_water');

  /// _(minecraft:falling_dust)_
  static const ParticleType falling_dust = ParticleType('minecraft:falling_dust');

  /// _(minecraft:falling_honey)_
  static const ParticleType falling_honey = ParticleType('minecraft:falling_honey');

  /// _(minecraft:falling_lava)_
  static const ParticleType falling_lava = ParticleType('minecraft:falling_lava');

  /// _(minecraft:falling_nectar)_
  static const ParticleType falling_nectar = ParticleType('minecraft:falling_nectar');

  /// _(minecraft:falling_obsidian_tear)_
  static const ParticleType falling_obsidian_tear = ParticleType('minecraft:falling_obsidian_tear');

  /// _(minecraft:falling_spore_blossom)_
  static const ParticleType falling_spore_blossom = ParticleType('minecraft:falling_spore_blossom');

  /// _(minecraft:falling_water)_
  static const ParticleType falling_water = ParticleType('minecraft:falling_water');
  ...
  static const ParticleType glow_squid_ink = ParticleType('minecraft:glow_squid_ink');

  /// _(minecraft:gust)_
  static const ParticleType gust = ParticleType('minecraft:gust');

  /// _(minecraft:gust_emitter_large)_
  static const ParticleType gust_emitter_large = ParticleType('minecraft:gust_emitter_large');

  /// _(minecraft:gust_emitter_small)_
  static const ParticleType gust_emitter_small = ParticleType('minecraft:gust_emitter_small');

  /// _(minecraft:happy_villager)_
  static const ParticleType happy_villager = ParticleType('minecraft:happy_villager');

  /// _(minecraft:heart)_
  static const ParticleType heart = ParticleType('minecraft:heart');

  /// _(minecraft:infested)_
  static const ParticleType infested = ParticleType('minecraft:infested');

  /// _(minecraft:instant_effect)_
  static const ParticleType instant_effect = ParticleType('minecraft:instant_effect');

  /// _(minecraft:item)_
  static const ParticleType item = ParticleType('minecraft:item');

  /// _(minecraft:item_cobweb)_
  static const ParticleType item_cobweb = ParticleType('minecraft:item_cobweb');
  ...
  static const ParticleType item_snowball = ParticleType('minecraft:item_snowball');

  /// _(minecraft:landing_honey)_
  static const ParticleType landing_honey = ParticleType('minecraft:landing_honey');

  /// _(minecraft:landing_lava)_
  static const ParticleType landing_lava = ParticleType('minecraft:landing_lava');

  /// _(minecraft:landing_obsidian_tear)_
  static const ParticleType landing_obsidian_tear = ParticleType('minecraft:landing_obsidian_tear');
  ...
  /// _(minecraft:ominous_spawning)_
  static const ParticleType ominous_spawning = ParticleType('minecraft:ominous_spawning');
  ...
  /// _(minecraft:raid_omen)_
  static const ParticleType raid_omen = ParticleType('minecraft:raid_omen');

  /// _(minecraft:rain)_
  static const ParticleType rain = ParticleType('minecraft:rain');

  /// _(minecraft:reverse_portal)_
  static const ParticleType reverse_portal = ParticleType('minecraft:reverse_portal');

  /// _(minecraft:scrape)_
  static const ParticleType scrape = ParticleType('minecraft:scrape');

  /// _(minecraft:sculk_charge)_
  static const ParticleType sculk_charge = ParticleType('minecraft:sculk_charge');

  /// _(minecraft:sculk_charge_pop)_
  static const ParticleType sculk_charge_pop = ParticleType('minecraft:sculk_charge_pop');
  ...
  /// _(minecraft:small_gust)_
  static const ParticleType small_gust = ParticleType('minecraft:small_gust');
  ...
  static const ParticleType soul_fire_flame = ParticleType('minecraft:soul_fire_flame');
  ...
  static const ParticleType spore_blossom_air = ParticleType('minecraft:spore_blossom_air');

  /// _(minecraft:squid_ink)_
  static const ParticleType squid_ink = ParticleType('minecraft:squid_ink');

  /// _(minecraft:sweep_attack)_
  static const ParticleType sweep_attack = ParticleType('minecraft:sweep_attack');

  /// _(minecraft:totem_of_undying)_
  static const ParticleType totem_of_undying = ParticleType('minecraft:totem_of_undying');

  /// _(minecraft:trial_omen)_
  static const ParticleType trial_omen = ParticleType('minecraft:trial_omen');

  /// _(minecraft:trial_spawner_detection)_
  static const ParticleType trial_spawner_detection = ParticleType('minecraft:trial_spawner_detection');

  /// _(minecraft:trial_spawner_detection_ominous)_
  static const ParticleType trial_spawner_detection_ominous = ParticleType('minecraft:trial_spawner_detection_ominous');

  /// _(minecraft:underwater)_
  static const ParticleType underwater = ParticleType('minecraft:underwater');

  /// _(minecraft:vault_connection)_
  static const ParticleType vault_connection = ParticleType('minecraft:vault_connection');

  /// _(minecraft:vibration)_
  static const ParticleType vibration = ParticleType('minecraft:vibration');

  /// _(minecraft:warped_spore)_
  static const ParticleType warped_spore = ParticleType('minecraft:warped_spore');
